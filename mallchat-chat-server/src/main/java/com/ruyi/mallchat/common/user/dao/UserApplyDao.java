...
import com.ruyi.mallchat.common.user.domain.enums.ApplyStatusEnum;
import com.ruyi.mallchat.common.user.domain.enums.ApplyTypeEnum;
import com.ruyi.mallchat.common.user.mapper.UserApplyMapper;
import org.springframework.stereotype.Service;

import java.util.List;

import static com.ruyi.mallchat.common.user.domain.enums.ApplyReadStatusEnum.READ;
import static com.ruyi.mallchat.common.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static com.ruyi.mallchat.common.user.domain.enums.ApplyStatusEnum.AGREE;
