...
import com.ruyi.mallchat.common.common.domain.vo.request.PageBaseReq;
import com.ruyi.mallchat.common.common.domain.vo.response.CursorPageBaseResp;
import com.ruyi.mallchat.common.common.domain.vo.response.PageBaseResp;
import com.ruyi.mallchat.common.user.domain.vo.request.friend.FriendApplyReq;
import com.ruyi.mallchat.common.user.domain.vo.request.friend.FriendApproveReq;
import com.ruyi.mallchat.common.user.domain.vo.request.friend.FriendCheckReq;
import com.ruyi.mallchat.common.user.domain.vo.response.friend.FriendApplyResp;
import com.ruyi.mallchat.common.user.domain.vo.response.friend.FriendCheckResp;
import com.ruyi.mallchat.common.user.domain.vo.response.friend.FriendResp;
import com.ruyi.mallchat.common.user.domain.vo.response.friend.FriendUnreadResp;
