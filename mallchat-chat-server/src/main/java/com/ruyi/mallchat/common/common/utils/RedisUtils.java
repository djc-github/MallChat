...
import com.ruyi.mallchat.utils.JsonUtils;
...
public class RedisUtils {
    ...
    /**
     * lua脚本：实现一个带有过期时间的自增操作。
     * 如果key不存在，它会创建一个新的key，将key的值设置为1，并指定过期时间。
     * 如果key已经存在，它将对该key的值执行自增操作，并返回自增后的结果。
     */
     ...
     *
     * @param keys   多个键
     * @param tClass value类型
     * @return 多个值，和键顺序一致，没有的值设置为null
     */
