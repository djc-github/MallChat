...
import com.ruyi.mallchat.common.common.domain.dto.LoginMessageDTO;
import com.ruyi.mallchat.common.common.domain.dto.ScanSuccessMessageDTO;
...
import com.ruyi.mallchat.common.user.service.UserService;
import com.ruyi.mallchat.common.user.service.WxMsgService;
import com.ruyi.mallchat.common.user.service.adapter.TextBuilder;
import com.ruyi.mallchat.common.user.service.adapter.UserAdapter;
...
public class WxMsgServiceImpl implements WxMsgService {
    ...
    public final String WX_EVENT_KEY_PREFIX = "qrscene_";
    ...
    public WxMpXmlOutMessage scan(WxMpService wxMpService, WxMpXmlMessage wxMpXmlMessage) {
        ...
        //获取事件码，如果为空则认为不是扫码，parseInt直接抛异常结束
        ...
        //没有注册，自动将用户openid注册并发送授权请求获取全部信息
        //user为空先注册,手动生成只有uid和openid的用户信息,以保存uid
        ...
        //授权url
        String authorizeUrl = String.format(URL, wxMpService.getWxMpConfigStorage().getAppId(), UriEncoder.encode(callback + "/wx/portal/public/callBack"));
    ...
    private String getEventKey(WxMpXmlMessage wxMpXmlMessage) {
        //扫码关注的渠道事件有前缀，需要去除
        return wxMpXmlMessage.getEventKey().replace(WX_EVENT_KEY_PREFIX, "");
    }
    ...
    private void fillUserInfo(Long uid, WxOAuth2UserInfo userInfo) {
        ...
        for (int i = 0; i < 5; i++) {
            try {
                ...
                log.info("更新用户信息重复 uid:{},info:{}", uid, userInfo);
            } catch (Exception e) {
                log.error("更新用户信息失败 uid:{},info:{}", uid, userInfo);
            }
            //用户名唯一，名字重置后重试
            update.setName(name + RandomUtil.randomInt(100000));
        }
    }
}
