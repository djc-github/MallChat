package com.ruyi.mallchat.chatai.handler;

import com.ruyi.mallchat.chat.domain.entity.Message;
import com.ruyi.mallchat.chat.domain.entity.msg.MessageExtra;
import com.ruyi.mallchat.chatai.domain.ChatGPTContext;
import com.ruyi.mallchat.chatai.domain.ChatGPTMsg;
import com.ruyi.mallchat.chatai.domain.builder.ChatGPTContextBuilder;
import com.ruyi.mallchat.chatai.domain.builder.ChatGPTMsgBuilder;
import com.ruyi.mallchat.chatai.properties.ChatGPTProperties;
import com.ruyi.mallchat.chatai.utils.ChatGPTUtils;
import com.ruyi.mallchat.common.constant.RedisKey;
import com.ruyi.mallchat.common.domain.dto.FrequencyControlDTO;
import com.ruyi.mallchat.common.exception.FrequencyControlException;
import com.ruyi.mallchat.common.service.frequencycontrol.FrequencyControlUtil;
import com.ruyi.mallchat.common.utils.DateUtils;
...
import static com.ruyi.mallchat.common.constant.RedisKey.USER_CHAT_CONTEXT;
import static com.ruyi.mallchat.common.service.frequencycontrol.FrequencyControlStrategyFactory.TOTAL_COUNT_WITH_IN_FIX_TIME_FREQUENCY_CONTROLLER;
