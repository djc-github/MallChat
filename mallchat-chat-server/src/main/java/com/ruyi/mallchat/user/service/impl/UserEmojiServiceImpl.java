...
import com.ruyi.mallchat.common.domain.vo.response.IdRespVO;
import com.ruyi.mallchat.common.utils.AssertUtil;
import com.ruyi.mallchat.user.dao.UserEmojiDao;
import com.ruyi.mallchat.user.domain.entity.UserEmoji;
import com.ruyi.mallchat.user.domain.vo.request.user.UserEmojiReq;
import com.ruyi.mallchat.user.domain.vo.response.user.UserEmojiResp;
import com.ruyi.mallchat.user.service.UserEmojiService;
