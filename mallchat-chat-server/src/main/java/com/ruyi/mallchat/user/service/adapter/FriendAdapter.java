package com.ruyi.mallchat.user.service.adapter;
...
import static com.ruyi.mallchat.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static com.ruyi.mallchat.user.domain.enums.ApplyStatusEnum.WAIT_APPROVAL;
import static com.ruyi.mallchat.user.domain.enums.ApplyTypeEnum.ADD_FRIEND;
