...
import com.ruyi.mallchat.chat.service.RoomService;
import com.ruyi.mallchat.chat.service.adapter.MessageAdapter;
import com.ruyi.mallchat.common.annotation.RedissonLock;
import com.ruyi.mallchat.common.domain.vo.request.CursorPageBaseReq;
import com.ruyi.mallchat.common.domain.vo.request.PageBaseReq;
import com.ruyi.mallchat.common.domain.vo.response.CursorPageBaseResp;
import com.ruyi.mallchat.common.domain.vo.response.PageBaseResp;
...
import com.ruyi.mallchat.user.dao.UserFriendDao;
import com.ruyi.mallchat.user.domain.entity.User;
import com.ruyi.mallchat.user.domain.entity.UserApply;
import com.ruyi.mallchat.user.domain.entity.UserFriend;
import com.ruyi.mallchat.user.domain.vo.request.friend.FriendApplyReq;
import com.ruyi.mallchat.user.domain.vo.request.friend.FriendApproveReq;
import com.ruyi.mallchat.user.domain.vo.request.friend.FriendCheckReq;
import com.ruyi.mallchat.user.domain.vo.response.friend.FriendApplyResp;
import com.ruyi.mallchat.user.domain.vo.response.friend.FriendCheckResp;
import com.ruyi.mallchat.user.domain.vo.response.friend.FriendResp;
import com.ruyi.mallchat.user.domain.vo.response.friend.FriendUnreadResp;
import com.ruyi.mallchat.user.service.FriendService;
import com.ruyi.mallchat.user.service.adapter.FriendAdapter;
...
import static com.ruyi.mallchat.user.domain.enums.ApplyStatusEnum.WAIT_APPROVAL;
