...
import com.ruyi.mallchat.user.domain.enums.ApplyStatusEnum;
import com.ruyi.mallchat.user.domain.enums.ApplyTypeEnum;
import com.ruyi.mallchat.user.mapper.UserApplyMapper;
import org.springframework.stereotype.Service;

import java.util.List;

import static com.ruyi.mallchat.user.domain.enums.ApplyReadStatusEnum.READ;
import static com.ruyi.mallchat.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static com.ruyi.mallchat.user.domain.enums.ApplyStatusEnum.AGREE;
